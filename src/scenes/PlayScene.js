class PlayScene extends Phaser.Scene {
  ...
  addBackground() {
    this.bg = new Sprite(this, gameStartX, gameStartY, "bg1")
      .setOrigin(0, 0)
    ...
    this.bg2 = new Sprite(this, gameStartX, gameStartY, "bg1")
      .setOrigin(0, 0)
      .setDisplaySize(gameWidth + deltaX, gameHeight + deltaY)
      .setTint(this.platformThemes[this.bgColorIndex].bg_color)
      .setAlpha(0);

    this.layer1 = new TileSprite(this, 
        gameStartX,
        gameHeight + 1000,
        gameWidth + deltaX,
        1041,
      ...
      .setOrigin(0, 1);
    this.layer2 = new TileSprite(this,
        gameStartX,
        gameStartY - 100,
        gameWidth + deltaX,
        346,
  ...
  updateGameTheme() {
    ...
    if (this.allNumberOfPlatformsInGame % number === 0) this.useNextPlatformTheme();
  ...
  addPlayer() {
    this.player = new Player(this, gameStartX - 70, halfGameHeight - 50, "player");
  }
  ...
  addGround() {
    this.ground = new TileSprite(this,
        gameStartX,
        gameHeight,
